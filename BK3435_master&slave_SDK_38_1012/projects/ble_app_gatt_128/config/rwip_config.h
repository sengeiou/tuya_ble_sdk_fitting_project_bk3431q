...
enum KE_EVENT_TYPE
{
    ...
    KE_EVENT_BLE_ADV_EVT_END   ,
    KE_EVENT_BLE_SCAN_EVT_END  ,
...
#if (BLE_HOST_PRESENT)
    TASK_L2CC = 7,    // L2CAP Controller Task
    TASK_GATTM = 8,   // Generic Attribute Profile Manager Task
    TASK_GATTC = 9,   // Generic Attribute Profile Controller Task
    TASK_GAPM = 10,    // Generic Access Profile Manager
    TASK_GAPC = 11,    // Generic Access Profile Controller
