...
//  <e> CFG_PRF_ELECTRIC
//  <i> ELECTRIC profile Locator Role
//  </e>
#if (1)
...
/// BLE_CLIENT_PRF indicates if at least one client profile is present
        ...
        || BLE_PAS_CLIENT || BLE_IPS_CLIENT || BLE_ENV_CLIENT || BLE_WSC_CLIENT || BLE_SDP_CLIENT || 1)
...
/// BLE_SERVER_PRF indicates if at least one server profile is present
		...
		|| BLE_FFF0_SERVER || BLE_FFE0_SERVER || 1)
