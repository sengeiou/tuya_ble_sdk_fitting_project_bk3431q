...
void clear_uart_buffer(void)
{
    ...
    uart_rx_index = 0;
    uart_rx_done = 0;
    memset((void *)uart_rx_buf, 0, sizeof(uart_rx_buf)); /**< Clear the RX buffer */
...
void TRAhcit_UART_Rx(void)
{
    ...
    case LINK_CHECK_CMD:		// 01 e0 fc 01 00
        ...
        memcpy(pHCItxBuf->param, (const void *)uart_rx_buf, pHCItxBuf->total);
    ...
    case REGISTER_WRITE_CMD: {   // 01 e0 fc 09 01 00 28 80 00 68 00 00 00
        ...
        memcpy(pHCItxBuf->param, (const void *)uart_rx_buf, 3);
