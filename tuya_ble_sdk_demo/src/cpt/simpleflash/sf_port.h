...
#define SF_AREA1_BASE       (0x6A000) //lock_hard
#define SF_AREA2_BASE       (0x6C000) //lock_event
#define SF_AREA3_BASE       (0x6E000) //offline_password
#define SF_AREA4_BASE       (0x70000) //master
