/**
****************************************************************************
* @file      tuya_ble_app_uart_module_handler.h
* @brief     tuya_ble_app_uart_module_handler
* @author    suding
* @version   V1.0.0
* @date      2020-04
* @note
...
#ifndef __TUYA_BLE_APP_UART_COMMON_HANDLER_H__
#define __TUYA_BLE_APP_UART_COMMON_HANDLER_H__
...
#endif //__TUYA_BLE_APP_UART_COMMON_HANDLER_H__
